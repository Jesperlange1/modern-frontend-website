    ...
    <nav class="nav topnav">
      <div class="small-width">
        <ul>
          <li class="currency">
            Currency:
            <select class="select item item2">
              ...
              <ul class="menu-point-offer">
                <li class="offer">
                  <a href>
                    ...
                    <br>
                    <span class="offer-text">UP TO 50% OFF</span>
                  </a>
                </li>
              </ul>
            </div>
